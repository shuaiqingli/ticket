		...
		<form method="post" id="adminForm" action="${basePath}/user/promotionadd.do">
			<div class="row">
				<div style="margin-left: 30px;">
					<label>规则名称</label>
					<input name="promotionname" type="text" class="span3" id="promotionname" value="调价规则" datatype="*" nullmsg="规则名称不能为空"/>
...
<!-- 			   <input type="hidden" name="weekdays" datatype="*" nullmsg="可选星期不能为空" value=""> -->
        	...
        	function addTime(){
				$("#timeSet").append('<div style="margin-left: 30px;"><label style="width:700px;"><input name="begintime" readonly="readonly" type="text" class="input-mini bootstrap-timepicker" placeholder="From" value="07:00"> - <input name="endtime" readonly="readonly" type="text" class="input-mini bootstrap-timepicker" placeholder="To" value="12:00">&nbsp;&nbsp;&nbsp;调价金额 <input name="reducesum" type="text" class="span3" style="width:100px" id="reducesum" value="0" datatype="d" nullmsg="面值不能为空">(元)&nbsp;&nbsp;&nbsp;<input name="couponpercent" type="hidden" class="span3" style="width:100px" id="couponpercent" value="100" datatype="percent" nullmsg="调价票百分不能为空"><a onclick="removeTime(this);"> <i class="icon-minus-sign"></i></a></label></div>');
			...
			<div class="row">
				...
				<div style="margin-left: 30px;">默认规则 是:
				  <input name="isdefault" type="radio" class="span1" value="1"/>
