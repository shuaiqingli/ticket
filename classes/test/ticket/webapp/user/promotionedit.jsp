		...
		<form method="post" id="adminForm"
            ...
            <div class="row" id="timeSet">
            	<c:forEach items="${tlist}" var="t">
                	...
                	&nbsp;&nbsp;&nbsp;优惠金额 <input name="reducesum" type="text" class="span3" style="width:100px" id="reducesum" value="${t.reducesum}" datatype="d" nullmsg="面值不能为空">(元)
                	&nbsp;&nbsp;&nbsp;优惠票百分比 <input name="couponpercent" type="text" class="span3" style="width:100px" id="couponpercent" value="${empty t.couponpercent ? 100:t.couponpercent}" datatype="percent" nullmsg="优惠票百分不能为空">%
