...
//
//					//获取当前时间
////					String currentDateNumber = DateHanlder.getCurrentDateTimeNumber();
////					Integer startShifId = 1;
//					//发车生成
...
////						String shCifId = currentDateNumber+NumberCreate.createNumber(startShifId, 4);
//						createShiftStart(shiftStart,lm, lineStation, code, startDate, startTime, tickeDate);
////						shiftStart.setId(shifId);
////						startShifId++;
//						if(shiftStarts!=null){
...
//				requireTime+=lms.getRequireTime();
//				if(lms.getSort()==1){
...
//						e.printStackTrace();
//					}
//					lineManageStation.setTime(requireTime);
//					lineManageStation.setRequireTime(requireTime);
