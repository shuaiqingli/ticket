	...
	<div class="container main_container">
		<form action="<%=basePath%>/admin/citystationlist.do" method="get">
			<div class="page-header">
				<a id="main_page" href="${basePath}/admin/citystationlist.do" style="color: black;border: none;"></a>
				<h2 onclick="location.href='${basePath}/admin/citystationlist.do'">
				<span style="color: #000;">
				<c:if test="${not empty page.data[0]}">
					( ${page.data[0].parent.cityname } )
				</c:if>
				</span>站点列表</h2>
			</div>
			<div class="row">
...
<%-- 							<td>${o.ishot ==1 ? '是':'否'}</td> --%>
							<td class="cls_hide">
								<div class="btn-group pull-right">
									...
									<a class="btn" href="<%=basePath%>/admin/prohibitList.do?stid=${o.id}">
										<i class="icon-list "></i> 禁售规则
									</a>
								</div>
							</td>
						</tr>
