...
<div class="container main_container">
    <div class="row">
        ...
        <div class="pull-left" style="padding-right:10px;width: 100%;" id="startArea">
            ...
            <select name="startCity" class="span2" onchange="refreshStation();">
                <c:forEach items="${cityList}" var="city">
                    <option value="${city.id}" <c:if test="${city.id == param.citystartid}">selected</c:if> >${city.cityname}</option>
                </c:forEach>
            </select>
            ...
            <select name="endCity" class="span2" onchange="refreshStation();">
                <c:forEach items="${cityList}" var="city" varStatus="i">
                    <option value="${city.id}"
                            <c:if test="${empty param.cityarriveid && i.index == 1}">selected</c:if><c:if test="${city.id == param.cityarriveid}">selected</c:if> >${city.cityname}</option>
                </c:forEach>
            </select>
        ...
        <div class="pull-left" style="padding-right:10px;">
            ...
            <input type="text" name="linename" placeholder="班次号" style="height:30px;" value="${param.linename}">
        ...
        <div style="color:#555;margin-top: 10px;font-size: 16px;" class="record_list">
            <div class="record_item"
                ...
                <div style="display: inline-block;width: 20%;float: left;">
                    ...
                    <div style="height: 25px;line-height: 25px;">已售:<a style="cursor: pointer;"><span
                            style="color:#ff6861;font-weight: bold;"
                ...
                <div style="display: inline-block;width: 20%;float: left;height: 80px;line-height: 80px;text-align: center;color: #ff6861;font-size: 25px;font-weight: bold;">
                    &yen;<span class="ticketprice">100</span><span class="showcontent"
                                                                   style="color: grey;font-size: 14px;font-weight:normal;"></span>
                </div>
...
<div class="layer_dialog" style="display:none;" id="freezeDialog">
    ...
    <div style="margin: 10px 10px 10px 10px;">
        <div class="seat_container">
            ...
            <div class="chair_items"
                 style="display: inline-block;border: 1px solid #ccc;display: none;margin-top: 10px;margin-right: 10px;margin-bottom: 10px;">
                <span class="chairNo">1</span>号
            </div>
